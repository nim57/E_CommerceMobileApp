        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              child: Center(
                child: Image(image: AssetImage(image),fit: BoxFit.cover,color: dark ?  TColor.light :TColor.dark,),
              ),
            ),
            ...
            SizedBox(
                width : 55,
                child: Text(tittle,style: Theme.of(context).textTheme.labelSmall!.apply(color: textColor),
                  maxLines: 1,
